...
class PessoaCriacaoResourceIT {
    ...
    public static PessoaCriacao createEntity(EntityManager em) {
        PessoaCriacao pessoaCriacao = new PessoaCriacao().idPessoa(DEFAULT_ID_PESSOA).idCriacao(DEFAULT_ID_CRIACAO);
    ...
    public static PessoaCriacao createUpdatedEntity(EntityManager em) {
        PessoaCriacao pessoaCriacao = new PessoaCriacao().idPessoa(UPDATED_ID_PESSOA).idCriacao(UPDATED_ID_CRIACAO);
        return pessoaCriacao;
    }
    ...
    void createPessoaCriacao() throws Exception {
        ...
        assertThat(testPessoaCriacao.getIdPessoa()).isEqualTo(DEFAULT_ID_PESSOA);
    ...
    void getAllPessoaCriacaos() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].idPessoa")
            .value(hasItem(DEFAULT_ID_PESSOA.intValue()))
            .jsonPath("$.[*].idCriacao")
    ...
    void getPessoaCriacao() {
        ...
        webTestClient
            ...
            .jsonPath("$.idPessoa")
            .value(is(DEFAULT_ID_PESSOA.intValue()))
            .jsonPath("$.idCriacao")
    ...
    void putNewPessoaCriacao() throws Exception {
        ...
        updatedPessoaCriacao.idPessoa(UPDATED_ID_PESSOA).idCriacao(UPDATED_ID_CRIACAO);
        ...
        PessoaCriacao testPessoaCriacao = pessoaCriacaoList.get(pessoaCriacaoList.size() - 1);
        assertThat(testPessoaCriacao.getIdPessoa()).isEqualTo(UPDATED_ID_PESSOA);
    ...
    void partialUpdatePessoaCriacaoWithPatch() throws Exception {
        ...
        partialUpdatedPessoaCriacao.idPessoa(UPDATED_ID_PESSOA);
    ...
    void fullUpdatePessoaCriacaoWithPatch() throws Exception {
        ...
        partialUpdatedPessoaCriacao.idPessoa(UPDATED_ID_PESSOA).idCriacao(UPDATED_ID_CRIACAO);
