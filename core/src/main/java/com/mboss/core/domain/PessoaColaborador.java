...
public class PessoaColaborador implements Serializable {
    ...
    public PessoaColaborador pessoaParentescos(Set<PessoaParentesco> pessoaParentescos) {
        this.setPessoaParentescos(pessoaParentescos);
        return this;
    }

    public PessoaColaborador addPessoaParentesco(PessoaParentesco pessoaParentesco) {
        this.pessoaParentescos.add(pessoaParentesco);
        pessoaParentesco.setPessoaColaborador(this);
        return this;
    }

    public PessoaColaborador removePessoaParentesco(PessoaParentesco pessoaParentesco) {
        this.pessoaParentescos.remove(pessoaParentesco);
        pessoaParentesco.setPessoaColaborador(null);
        return this;
    }

    public void setPessoaParentescos(Set<PessoaParentesco> pessoaParentescos) {
        if (this.pessoaParentescos != null) {
            this.pessoaParentescos.forEach(i -> i.setPessoaColaborador(null));
        }
        if (pessoaParentescos != null) {
            pessoaParentescos.forEach(i -> i.setPessoaColaborador(this));
        }
