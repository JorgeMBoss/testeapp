...
public class Criacao implements Serializable {
    ...
    @JsonIgnoreProperties(value = { "criacaos" }, allowSetters = true)
    @Transient
    ...
    public Criacao criacaoConsumos(Set<CriacaoConsumo> criacaoConsumos) {
        this.setCriacaoConsumos(criacaoConsumos);
        return this;
    }

    public Criacao addCriacaoConsumo(CriacaoConsumo criacaoConsumo) {
        this.criacaoConsumos.add(criacaoConsumo);
        criacaoConsumo.getCriacaos().add(this);
        return this;
    }

    public Criacao removeCriacaoConsumo(CriacaoConsumo criacaoConsumo) {
        this.criacaoConsumos.remove(criacaoConsumo);
        criacaoConsumo.getCriacaos().remove(this);
        return this;
    }

    public void setCriacaoConsumos(Set<CriacaoConsumo> criacaoConsumos) {
        if (this.criacaoConsumos != null) {
            this.criacaoConsumos.forEach(i -> i.removeCriacao(this));
        }
        if (criacaoConsumos != null) {
            criacaoConsumos.forEach(i -> i.addCriacao(this));
        }
