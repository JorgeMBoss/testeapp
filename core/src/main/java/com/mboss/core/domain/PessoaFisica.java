...
public class PessoaFisica implements Serializable {
    ...
    @Transient
    @JsonIgnoreProperties(value = { "pessoaFisica", "pessoaColaborador" }, allowSetters = true)
    ...
    public PessoaFisica idade(Integer idade) {
        this.idade = idade;
        return this;
    }
    ...
    public PessoaFisica sexo(String sexo) {
        this.sexo = sexo;
        return this;
    }
    ...
    public PessoaFisica cor(String cor) {
        this.cor = cor;
        return this;
    }
    ...
    public PessoaFisica estadoCivil(String estadoCivil) {
    ...
    public PessoaFisica naturalidade(String naturalidade) {
    ...
    public PessoaFisica nacionalidade(String nacionalidade) {
    ...
    public PessoaFisica pessoaComplemento(PessoaComplemento pessoaComplemento) {
    ...
    public PessoaFisica pessoaParentescos(Set<PessoaParentesco> pessoaParentescos) {
        this.setPessoaParentescos(pessoaParentescos);
        return this;
    }

    public PessoaFisica addPessoaParentesco(PessoaParentesco pessoaParentesco) {
        this.pessoaParentescos.add(pessoaParentesco);
        pessoaParentesco.setPessoaFisica(this);
        return this;
    }

    public PessoaFisica removePessoaParentesco(PessoaParentesco pessoaParentesco) {
        this.pessoaParentescos.remove(pessoaParentesco);
        pessoaParentesco.setPessoaFisica(null);
        return this;
    }

    public void setPessoaParentescos(Set<PessoaParentesco> pessoaParentescos) {
        if (this.pessoaParentescos != null) {
            this.pessoaParentescos.forEach(i -> i.setPessoaFisica(null));
        }
        if (pessoaParentescos != null) {
            pessoaParentescos.forEach(i -> i.setPessoaFisica(this));
        }
    ...
    public PessoaFisica pessoa(Pessoa pessoa) {
