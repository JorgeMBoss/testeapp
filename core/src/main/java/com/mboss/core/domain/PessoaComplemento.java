...
public class PessoaComplemento implements Serializable {
    ...
    public PessoaComplemento pessoaFisca(PessoaFisca pessoaFisca) {
        this.setPessoaFisca(pessoaFisca);
        return this;
    }

    public void setPessoaFisca(PessoaFisca pessoaFisca) {
        if (this.pessoaFisca != null) {
            this.pessoaFisca.setPessoaComplemento(null);
        }
        if (pessoaFisca != null) {
            pessoaFisca.setPessoaComplemento(this);
        }
