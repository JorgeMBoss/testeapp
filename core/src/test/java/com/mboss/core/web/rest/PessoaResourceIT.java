...
class PessoaResourceIT {
    ...
    private static final Boolean DEFAULT_IS_PESSOA_FISICA = false;
    private static final Boolean UPDATED_IS_PESSOA_FISICA = true;

    private static final Boolean DEFAULT_IS_COLABORADOR = false;
    private static final Boolean UPDATED_IS_COLABORADOR = true;

    private static final Boolean DEFAULT_IS_MEDICO = false;
    private static final Boolean UPDATED_IS_MEDICO = true;
    ...
    public static Pessoa createEntity(EntityManager em) {
        Pessoa pessoa = new Pessoa()
            ...
            .isPessoaFisica(DEFAULT_IS_PESSOA_FISICA)
            .isColaborador(DEFAULT_IS_COLABORADOR)
            .isMedico(DEFAULT_IS_MEDICO)
            .ativo(DEFAULT_ATIVO);
        return pessoa;
    }
    ...
    public static Pessoa createUpdatedEntity(EntityManager em) {
        Pessoa pessoa = new Pessoa()
            ...
            .isPessoaFisica(UPDATED_IS_PESSOA_FISICA)
            .isColaborador(UPDATED_IS_COLABORADOR)
            .isMedico(UPDATED_IS_MEDICO)
            .ativo(UPDATED_ATIVO);
        return pessoa;
    }
    ...
    void createPessoa() throws Exception {
        ...
        assertThat(testPessoa.getIsPessoaFisica()).isEqualTo(DEFAULT_IS_PESSOA_FISICA);
        assertThat(testPessoa.getIsColaborador()).isEqualTo(DEFAULT_IS_COLABORADOR);
        assertThat(testPessoa.getIsMedico()).isEqualTo(DEFAULT_IS_MEDICO);
    ...
    void getAllPessoas() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].isPessoaFisica")
            .value(hasItem(DEFAULT_IS_PESSOA_FISICA.booleanValue()))
            .jsonPath("$.[*].isColaborador")
            .value(hasItem(DEFAULT_IS_COLABORADOR.booleanValue()))
            .jsonPath("$.[*].isMedico")
            .value(hasItem(DEFAULT_IS_MEDICO.booleanValue()))
            .jsonPath("$.[*].ativo")
    ...
    void getPessoa() {
        ...
        webTestClient
            ...
            .jsonPath("$.isPessoaFisica")
            .value(is(DEFAULT_IS_PESSOA_FISICA.booleanValue()))
            .jsonPath("$.isColaborador")
            .value(is(DEFAULT_IS_COLABORADOR.booleanValue()))
            .jsonPath("$.isMedico")
            .value(is(DEFAULT_IS_MEDICO.booleanValue()))
            .jsonPath("$.ativo")
    ...
    void putNewPessoa() throws Exception {
        ...
        assertThat(testPessoa.getIsPessoaFisica()).isEqualTo(UPDATED_IS_PESSOA_FISICA);
        assertThat(testPessoa.getIsColaborador()).isEqualTo(UPDATED_IS_COLABORADOR);
        assertThat(testPessoa.getIsMedico()).isEqualTo(UPDATED_IS_MEDICO);
